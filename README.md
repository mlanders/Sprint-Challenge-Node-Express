...
-   [ ] Describe Middleware?
    ...
    -   Middleware allows the incoming request to go through other functions prior to the final spot

-   [ ] Describe a Resource?

    -   A resource is the data that is on the server that the CRUD operations act upon

-   [ ] What can the API return to help clients know if a request was successful?

    -   An API returns a status code and / or a message

-   [ ] How can we partition our application into sub-applications?
    -   Use Express router allows you to split up the application.
    -   You can also use express within express as well
